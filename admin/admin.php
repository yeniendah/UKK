...
<span style="font-family:monospace; font-size:17px;">Dashboard</span></a>
      ...
      <!-- Divider -->
      <hr class="sidebar-divider" style="size:20px;">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?url=-lihattanggapan">Data Pengaduan</a>
            <a class="collapse-item" href="?url=lihat_pengaduan">Data Tanggapan</a>
          </div>
        </div>
      </li>
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?url=preview_tanggapan_c">Laporan Tanggapan</a>
          </div>
        </div>
      </li>
    ...
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column" style="background-image:url(../img/f.jpg);">

      <!-- Main Content -->
      <div id="content" style="background-color:white; background-repeat: no-repeat;
