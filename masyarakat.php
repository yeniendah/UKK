...
<body id="page-top" style="background-color:white">
  ...
  <div id="wrapper" style="background-color:white">
    ...
    background-size: cover;" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="?url=edit_masyarakat">
          <i class="fas fa-edit"></i>
          <span style="font-family:monospace; font-size:17px;">Edit Profil</span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="?url=tulis_pengaduan">
          ...
          <span style="font-family:monospace; font-size:17px;">Tulis Pengaduan</span></a>
      </li>
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="?url=lihat_pengaduan">
          <i class="fas fa-search"></i>
          <span style="font-family:monospace; font-size:17px;">Lihat Pengaduan</span></a>
      </li>
